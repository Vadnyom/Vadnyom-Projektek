...
//        {
//            var response = await _client.GetAsync($"{_baseUrl}/DesktopModules/Hotcakes/API/rest/v1/products/bySku/{sku}"); // http://{Ide írjátok a weblap Ip címét}/DesktopModules/Hotcakes/API/rest/v1/orders?key={ide meg a generált Api kulcsot}
